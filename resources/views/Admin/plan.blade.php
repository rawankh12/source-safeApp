    ...
    <div class="page d-flex">
        <div class="sidebar bg-white p-20 p-relative">
            ...
            <ul>
                ...
                <li>
                    <a class="active d-flex align-items fs-14 rad-6 c-black p-10" href="plan.html">
        ...
        <div class="content w-full">
            ...
            <h1 class="p-relative">Plan Ali</h1>
            <div class="plan-page m-20 d-flex gap-20">
                <div class="plan green bg-white p-20">
                    ...
                    <ul class="m-0">
                        <li>
                            <i class="fa fa-check fa-fw yes"></i>
                    ...
                    <a class="bg-green c-white w-full button-shape" href="#">Join</a>
                </div>
